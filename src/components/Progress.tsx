...
export function Progress({ percentage }: Props) {
  ...
  return (
    <View className="w-full h-7 rounded-full bg-gray-800 overflow-hidden flex-row items-center">
      <View
        className="h-7 items-end justify-center rounded-full bg-green-400"
        style={{ width: `${width}%` }}
      >
        {percentage >= 60 && (
